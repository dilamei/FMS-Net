...
class SpecialTokensMixin:
    ...
    def add_tokens(self, new_tokens: Union[str, AddedToken, List[str], List[AddedToken]], special_tokens=False) -> int:
        ...
        Examples::
            ...
            tokenizer = BertTokenizerFast.from_pretrained('models-bert-base-uncased')
    ...
    def from_pretrained(cls, *inputs, **kwargs):
        ...
        Args:
            pretrained_model_name_or_path: either:
                ...
                - a string with the `shortcut name` of a predefined tokenizer to load from cache or download, e.g.: ``models-bert-base-uncased``.
                - a string with the `identifier name` of a predefined tokenizer that was user-uploaded to our S3, e.g.: ``dbmdz/models-bert-base-german-cased``.
        ...
        Examples::
            ...
            tokenizer = BertTokenizer.from_pretrained('dbmdz/models-bert-base-german-cased')
            ...
            tokenizer = BertTokenizer.from_pretrained('models-bert-base-uncased', unk_token='<unk>')
