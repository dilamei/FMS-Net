...
BERT_PRETRAINED_MODEL_ARCHIVE_LIST = [
    ...
    "models-bert-large-uncased-whole-word-masking",
    "models-bert-large-cased-whole-word-masking",
    "models-bert-large-uncased-whole-word-masking-finetuned-squad",
    "models-bert-large-cased-whole-word-masking-finetuned-squad",
    "models-bert-base-cased-finetuned-mrpc",
    "models-bert-base-german-dbmdz-cased",
    "models-bert-base-german-dbmdz-uncased",
    "cl-tohoku/models-bert-base-japanese",
    "cl-tohoku/models-bert-base-japanese-whole-word-masking",
    "cl-tohoku/models-bert-base-japanese-char",
    "cl-tohoku/models-bert-base-japanese-char-whole-word-masking",
    "TurkuNLP/models-bert-base-finnish-cased-v1",
    "TurkuNLP/models-bert-base-finnish-uncased-v1",
    "wietsedv/models-bert-base-dutch-cased",
...
class BertModel(BertPreTrainedModel):
    ...
    @add_code_sample_docstrings(tokenizer_class=_TOKENIZER_FOR_DOC, checkpoint="models-bert-base-uncased")
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
...
class BertForPreTraining(BertPreTrainedModel):
    ...
    Examples::
        ...
        >>> model = BertForPreTraining.from_pretrained('models-bert-base-uncased')
...
class BertLMHeadModel(BertPreTrainedModel):
    ...
    Example::
        ...
        >>> model = BertLMHeadModel.from_pretrained('models-bert-base-cased', config=config)
...
class BertForNextSentencePrediction(BertPreTrainedModel):
    ...
    Examples::
        ...
        >>> tokenizer = BertTokenizer.from_pretrained('models-bert-base-uncased')
        >>> model = BertForNextSentencePrediction.from_pretrained('models-bert-base-uncased')
